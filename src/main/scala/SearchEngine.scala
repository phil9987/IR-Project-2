...
object SearchEngine {
  ...
  def readLanguageSetup() = {
    ...
    var fhrInput = ""
    do {
      println(s"fancyHitBonus : ( counts as bonus occurrences if the word appears in the document title) [ double, default = $bestLanguageFancyHitRange ] ") //TODO write explanation
